...
CREATE INDEX "class_subject_id_idx" ON "classes" USING btree ("subject_id");--> statement-breakpoint
CREATE INDEX "class_teacher_id_idx" ON "classes" USING btree ("teacher_id");--> statement-breakpoint
